...
export default function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        createMany: procedure.input($Schema.ToolInputSchema.createMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).tool.createMany(input as any))),
        ...
        deleteMany: procedure.input($Schema.ToolInputSchema.deleteMany).mutation(async ({ ctx, input }) => checkMutate(db(ctx).tool.deleteMany(input as any))),
        ...
        findFirst: procedure.input($Schema.ToolInputSchema.findFirst).query(({ ctx, input }) => checkRead(db(ctx).tool.findFirst(input as any))),

        findMany: procedure.input($Schema.ToolInputSchema.findMany).query(({ ctx, input }) => checkRead(db(ctx).tool.findMany(input as any))),
